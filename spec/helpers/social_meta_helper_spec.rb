...
RSpec.describe SocialMetaHelper, type: :helper do
  ...
  describe "#open_graph_tag" do
    ...
    context "when using a image path for content" do
      ...
      it "generates a meta tag with the correct asset image url" do
        expect(subject).to match(%r{<meta property="og:image" content="https://demokra.si/assets/os-social/opengraph-image.png" />})
      end
    end
  end
  ...
  describe "#twitter_card_tag" do
    ...
    context "when using a image path for content" do
      ...
      it "generates a meta tag with the correct asset image url" do
        expect(subject).to match(%r{<meta name="twitter:image" content="https://demokra.si/assets/os-social/opengraph-image.png" />})
      end
    end
  end
end
