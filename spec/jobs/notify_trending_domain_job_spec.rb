...
RSpec.describe NotifyTrendingDomainJob, type: :job do
  ...
  it "sends a notification to the Slack channel" do
    ...
    message << "<https://moderate.demokra.si/admin/petitions/#{petition.id}|Do Stuff!> "
    message << "from <https://moderate.demokra.si/admin/petitions/#{petition.id}/signatures?q=%40example.com&window=2019-03-31T16%3A00%3A00Z|example.com>"
