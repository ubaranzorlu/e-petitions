...
RSpec.describe Admin::PetitionTopicsController, type: :controller, admin: true do
  let!(:petition) { FactoryBot.create(:open_petition) }

  context "when not logged in" do
    describe "GET /admin/petitions/:petition_id/topics" do
    ...
    describe "PATCH /admin/petitions/:petition_id/topics" do
      it "redirects to the login page" do
