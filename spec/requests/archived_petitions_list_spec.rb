...
RSpec.describe "API request to list archived petitions", type: :request, show_exceptions: true do
  ...
  describe "links" do
    ...
    it "returns a link to itself" do
      ...
      expect(response).to be_successful
      expect(links).to include("self" => "https://demokra.si/archived/petitions.json")
    end
    ...
    it "returns a link to the first page of results" do
      ...
      expect(response).to be_successful
      expect(links).to include("first" => "https://demokra.si/archived/petitions.json?count=2")
    end
    ...
    it "returns a link to the last page of results" do
      ...
      expect(response).to be_successful
      expect(links).to include("last" => "https://demokra.si/archived/petitions.json?count=2&page=2")
    end
    ...
    it "returns a link to the next page of results if there is one" do
      ...
      expect(response).to be_successful
      expect(links).to include("next" => "https://demokra.si/archived/petitions.json?count=2&page=2")
    end
    ...
    it "returns a link to the previous page of results if there is one" do
      ...
      expect(response).to be_successful
      expect(links).to include("prev" => "https://demokra.si/archived/petitions.json?count=2")
    end
    ...
    it "returns the last link == first link for empty results" do
      ...
      expect(response).to be_successful
      expect(links).to include("last" => "https://demokra.si/archived/petitions.json?count=2&state=rejected")
    end
    ...
    it "returns previous page link == last link when paging off the end of the results" do
      ...
      expect(response).to be_successful
      expect(links).to include("prev" => "https://demokra.si/archived/petitions.json?count=2&state=rejected")
    end
  end
        ...
        a_collection_containing_exactly(
          a_hash_including(
            "links" => a_hash_including(
              "self" => "https://demokra.si/archived/petitions/#{petition.id}.json"
            )
          )
        )
      )
